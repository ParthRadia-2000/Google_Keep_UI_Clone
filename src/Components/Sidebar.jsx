      ...
      <>
        <div className="sidebar">
          <div className="first">
            ...
            <span className="child-name">Notes</span>
          </div>
          <div className="second">
            ...
            <span className="child-name">Reminders</span>
          </div>
          <div className="third">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="child-name">Labels</span>
          </div>
          <div className="fourth">
            ...
            <span className="child-name">Edit labels</span>
          </div>
          <div className="fifth">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="child-name">Archive</span>
          </div>
          <div className="sixth">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="child-name">Trash</span>
          </div>
        </div>
      </>
    );
